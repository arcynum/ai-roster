...
- [S#f8c3b0c2] Staff need to be rostered on for at least their FTE hours per 14-day fortnight block. This is enforced on a per-block basis and cannot be averaged across the entire roster period.
...
- [S#d2a7f4a6] All staff need to have an equal distributed number of night shifts based on their FTE. There are more day shifts than night shifts, so the balance of nights and days will not be exactly the same - but the distribution should be fair.
